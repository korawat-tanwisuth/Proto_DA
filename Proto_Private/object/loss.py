...
class ProtoLoss(nn.Module):
    def __init__(self, nav_t: float, s_par: Optional[float] = 0.5):
    ...
    def forward(self, mu_s: torch.Tensor, f_t: torch.Tensor) -> torch.Tensor:
        ...
        source_loss = (self.s_par*cost_mat*real_dist).sum(0).mean() 
        target_loss = ((1-self.s_par)*cost_mat*fake_dist).sum(1).mean()
